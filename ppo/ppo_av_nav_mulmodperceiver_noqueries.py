...
from models import MulModPerceiverIO_NoQueries_ActorCritic
...
def main():
    ...
    if args.agent_type == "mulmod-perceiver":
        agent = MulModPerceiverIO_NoQueries_ActorCritic(single_observation_space, single_action_space,
    ...
    for global_step in range(1, args.total_steps+1, args.num_steps * args.num_envs):
        for rollout_step in range(args.num_steps):
            ...
            # Sample action
            with th.no_grad():
                action, action_logprobs, _, value = \
                    agent.act(obs_th)
        ...
        with th.no_grad():
            ...
            value = agent.get_value(obs_th).flatten()
            # By default, use GAE
        ...
        for _ in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue = \
                    agent.act(mb_observations, actions=b_actions[mb_inds])

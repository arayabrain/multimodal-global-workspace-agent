...
def main():
    ...
    ppo_gru_agent_state_dict = th.load("/home/rousslan/random/rl/exp-logs/ss-hab/ppo_savi__ss1_rgb_spectro_seed_111__2022_10_26_14_56_01_300976.musashi/models/ppo_agent.4998001.ckpt.pth")
    ...
    DATASET_TOTAL_STEPS= 750_000 # int(5e3) # int(1e6)
    DATASET_DIR_PATH = f"ppo_gru_savi_dset_2022_10_27__{DATASET_TOTAL_STEPS}_STEPS"
